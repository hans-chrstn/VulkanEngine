...
namespace Engine::Renderer {
    VulkanGraphicsPipeline::VulkanGraphicsPipeline(
        ...
        if (vkCreateDescriptorSetLayout(_device, &layoutInfo, nullptr,
            ...
            ENGINE_FATAL("Failed to create descriptor set layout");
        }
        ...
        if (vkCreateGraphicsPipelines(_device, VK_NULL_HANDLE, 1, &pipelineInfo,
            ...
            ENGINE_FATAL("Failed to create graphics pipeline");
        }
    ...
    VulkanGraphicsPipeline::createShaderModule(const std::vector<char> &code) {
        ...
        if (vkCreateShaderModule(_device, &createInfo, nullptr,
                                 &shaderModule) != VK_SUCCESS) {
            ENGINE_FATAL("Failed to create shader module");
        }
